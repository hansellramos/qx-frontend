angular
    ...
    .factory('CertificateGetService', ['$resource', 'APPLICATION', function ($resource, APPLICATION) {
        return $resource(APPLICATION.CONFIG.API.URL + APPLICATION.CONFIG.API.RESOURCES.CERTIFICATE + '-/:id'
            , {id: '@id'})
    }])
